...
{
    /// <summary>
    ///     <para>Measurementdefinition with latest result</para>
    ///     Klasse ExRestMeasurementDefinitionWithLatestResult. (C) 2024 FOTEC Forschungs- und Technologietransfer GmbH
    /// </summary>
    public class ExRestMeasurementDefinitionWithLatestResult
    {
        #region Properties
        ...
        ///     Letztes Ergebnis
        /// </summary>
        public ExRestMeasurementResult LatestResult { get; set; } = null!;

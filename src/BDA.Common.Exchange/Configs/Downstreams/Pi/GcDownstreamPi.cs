...
namespace BDA.Common.Exchange.Configs.Downstreams.Pi
{
    /// <summary>
    ///     <para>Mögliche Messwerte für Raspberry Pi</para>
    ///     Klasse GcDownstreamArduino. (C) 2022 FOTEC Forschungs- und Technologietransfer GmbH
    /// </summary>
    public class GcDownstreamPi : GcDownstreamBase
    {
        #region Properties
        ...
        ///     Typ des Messwerts
        /// </summary>
        public EnumIotDevicePiMeasurementTypes PiMeasurementType { get; set; }
        ...
        {
            return new[] {(byte) PiMeasurementType};
        }
        ...
        public override ExMeasurementDefinition ToExMeasurementDefinition()
        {
            return new ExMeasurementDefinition
            {
                ...
                DownstreamType = EnumIotDeviceDownstreamTypes.Pi,

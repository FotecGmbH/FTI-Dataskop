...
namespace BDA.Common.Exchange.Configs.Plattform
{
    ...
    /// </summary>
    public class GcPlatformOpenSense : ConfigPlattformBase
    {
        /// <summary>
        ...
        /// </summary>
        public GcPlatformOpenSense() : base(EnumIotDevicePlattforms.OpenSense)
        {
            SupportedDownstreamTypes.Add(EnumIotDeviceDownstreamTypes.OpenSense);
        }
    }
}